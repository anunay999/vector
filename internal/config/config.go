...
func Default() *Config {
	return &Config{
		...
		Roles: map[string]Role{
			...
			"worker":     {Tier: "cheap", Prefer: []string{"openrouter/z-ai/glm-5.3-flash", "openrouter/deepseek/deepseek-v4.1-flash"}, Description: "Scoped edits, mechanical fixes, resolving comments."},
